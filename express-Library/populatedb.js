...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb+srv://cooluser:coolpassword@cluster0-mbdj7.mongodb.net/local_test_library?retryWrites=true');
...
function createGenreAuthors(cb) {
    async.series([
        function(callback) {
          authorCreate('Von Goethe', 'Wolfgang', '1673-06-06', false, callback);
        }
        function(callback) {
...
function createBookInstances(cb) {
    async.parallel([
        function(callback) {
          bookInstanceCreate(books[0], 'Wolfgang Von Goethe', false, 'Available', callback)
        }
        function(callback) {
